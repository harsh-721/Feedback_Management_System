...
public class StaffAddStudent extends javax.swing.JFrame {
    ...
    public StaffAddStudent() {
       super("Add,Edit & Update Student - Staff | FEEDBACK MANAGEMENT SYSTEM");
        initComponents();
        fetchStudentDetails();
    }
    ...
    public boolean updateStudent(){
        ...
        try{
            Connection con = FMSDatabaseConnection.getConnection();
            String sql = "UPDATE student SET Email= ?,FirstName= ?, LastName= ?, Password= ? WHERE ID = ?";
            PreparedStatement ps = con.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("STAFF ADD STUDENT | FEEDBACK MANAGEMENT SYSTEM");
        ...
        edtFirstName.setPlaceholder("Student First Name ");
        ...
        edtLastName.setPlaceholder("Student Last Name ");
        ...
        edtStudentID.setPlaceholder("Student ID");
        ...
        edtEmail.setPlaceholder("Student Email Address");
        ...
        tblStudentList.setColorBackgoundHead(new java.awt.Color(255, 255, 0));
